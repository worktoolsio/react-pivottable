...
function makeRenderer(PlotlyComponent) {
  ...
  Renderer.defaultProps = _Utilities.PivotData.defaultProps;
  Renderer.propTypes = _Utilities.PivotData.propTypes;
...
function makePieRenderer(PlotlyComponent) {
  var Renderer = function (_React$PureComponent3) {
    _inherits(Renderer, _React$PureComponent3);
    ...
    _createClass(Renderer, [{
      ...
      value: function render() {
        ...
        var data = { labels: [], values: [], text: [], type: 'pie', mode: 'markers' };
...
function createPlotlyRenderers(PlotlyComponent) {
  return {
    ...
    'Stacked Bar Chart': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'stack' }, true),
    'Pie Chart': makeRenderer(PlotlyComponent, { type: 'pie', mode: 'markers' }, {}),
